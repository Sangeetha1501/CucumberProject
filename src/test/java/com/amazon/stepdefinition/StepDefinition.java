...
public class StepDefinition extends BaseClass {
	...
	public void user_click_on_sign_in_button_on_ajax_call() {
	...
	@When("^User enter the username '(.*)' in the emailid/mobile number$")
	...
	@When("^User count the employee '(.*)' wise$")
	public void user_count_the_employee_location_wise(String headerName) {
	   pm.getWebTablePage().getEmployeeDataAndItsCount(headerName);
	}
